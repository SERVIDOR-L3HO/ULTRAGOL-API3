...
async function scrapMejoresMomentosPremier() {
  try {
    const queries = [
      'Premier League mejores momentos',
      'Premier League highlights',
      'Premier League best moments',
    ...
    console.error("Error obteniendo mejores momentos de Premier League:", error.message);
    throw error;
  }
}
...
module.exports = { scrapMejoresMomentosPremier };
