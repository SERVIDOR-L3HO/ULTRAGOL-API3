...
async function scrapMejoresMomentosLaLiga() {
  try {
    const queries = [
      'La Liga mejores momentos',
      'La Liga highlights',
      'La Liga best moments',
      'La Liga goals',
      'La Liga resumen'
    ];
    ...
    console.error("Error obteniendo mejores momentos de La Liga:", error.message);
    throw error;
  }
}
...
module.exports = { scrapMejoresMomentosLaLiga };
