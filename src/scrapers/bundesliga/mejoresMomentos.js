...
async function scrapMejoresMomentosBundesliga() {
  try {
    const queries = [
      'Bundesliga mejores momentos',
      'Bundesliga highlights',
      'Bundesliga best moments',
      'Bundesliga goals',
      'Bundesliga resumen'
    ];
    ...
    console.error("Error obteniendo mejores momentos de Bundesliga:", error.message);
    throw error;
  }
}
...
module.exports = { scrapMejoresMomentosBundesliga };
