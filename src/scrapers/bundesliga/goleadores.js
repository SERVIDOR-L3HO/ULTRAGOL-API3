...
async function scrapGoleadoresBundesliga() {
  try {
    const url = "https://www.espn.com/soccer/stats/_/league/GER.1/season/2025/view/scoring";
    ...
    console.error("Error scraping goleadores Bundesliga:", error.message);
    throw error;
  }
}

module.exports = { scrapGoleadoresBundesliga };
