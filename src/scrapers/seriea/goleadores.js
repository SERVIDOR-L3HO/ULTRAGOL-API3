...
async function scrapGoleadoresSerieA() {
  try {
    const url = "https://www.espn.com/soccer/stats/_/league/ITA.1/season/2025/view/scoring";
    ...
    console.error("Error scraping goleadores Serie A:", error.message);
    throw error;
  }
}

module.exports = { scrapGoleadoresSerieA };
