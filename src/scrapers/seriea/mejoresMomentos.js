...
async function scrapMejoresMomentosSerieA() {
  try {
    const queries = [
      'Serie A mejores momentos',
      'Serie A highlights',
      'Serie A best moments',
      'Serie A goals',
      'Serie A resumen'
    ];
    ...
    console.error("Error obteniendo mejores momentos de Serie A:", error.message);
    throw error;
  }
}
...
module.exports = { scrapMejoresMomentosSerieA };
