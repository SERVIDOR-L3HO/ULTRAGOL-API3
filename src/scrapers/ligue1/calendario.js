...
async function scrapCalendarioLigue1() {
  try {
        ...
        $(element).find("tbody tr").each((i, row) => {
          ...
          if (equipoLocal && equipoVisitante && horaTexto) {
            ...
            const partido = {
              ...
              hora: horaTexto,
              fechaCompleta: fechaPartido.toLocaleString("fr-FR", { 
              ...
              contador: contador,
              estadio: estadio || "À confirmer",
              canalesTV: canalesTV || "Non disponible",
              apuestas: {
                local: oddsLocal,
...
module.exports = { scrapCalendarioLigue1 };
